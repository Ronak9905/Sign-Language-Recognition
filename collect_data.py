...
def update_frame(root, label):
    global stop_flag, fullscreen, is_maximized, current_result, recording, out, video_counter, capture_flag
...
def on_key_press(event):
    global stop_flag, fullscreen, current_result, recording, out, video_counter, capture_flag, last_saved_landmarks
...
# Create main window
root = tk.Tk()
root.title("Data Collection - Sign Language Recognition")
